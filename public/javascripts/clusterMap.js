           ...
           map.on('load', () => {    //map.on(on-method) used for adding event and listen to those event
                    // Add a new source from our GeoJSON data and
                    // set the 'cluster' option to true. GL-JS will
                    // add the point_count property to your source data.
           console.log(data),
           map.addSource('campgrounds', {   //earthquakes is source or label we have to change that label to campground 
           type: 'geojson',
